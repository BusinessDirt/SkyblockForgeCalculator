...
class PythonConfiguration:
    @classmethod
    def validate(cls, packages: list = [], version_major: int = 3, version_minor:int = 3) -> bool:
        if not cls.__validate_python__(version_major, version_minor):
    ...
    @classmethod
    def __validate_python__(cls, version_major: int, version_minor: int) -> bool:
